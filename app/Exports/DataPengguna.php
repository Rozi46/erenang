    ...
    public function view(): View
    {
    	if(!session()->has('key_token_renang') && !session()->has('admin_login_renang')){
            ...
            $results = $results[0]['original'];
             ...
             return view($viewpath,['url_api' => $url_api,'app' => $request['app'],'url_active' => $request['url_active'],'request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
}
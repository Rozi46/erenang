        ...
        <table class="table_view table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style="width:400px; text-align: center;">Nama Club</th>
                    <th style="width:200px; text-align: center;">Kota Asal</th>
                    <th style="width:150px; text-align: center;">Kontak</th>
                </tr>
            </thead>
            <tbody>
                <?php $no = 0;?> @forelse($results['data'] as $view_data) <?php $no++ ;?>
                    <tr>
                        ...
                        <td class="strtable">{{$view_data['nama_club']}}</td>
                        <td class="strtable">{{$view_data['kota_asal']}}</td>
                        <td class="strtable" style="text-align:center;">{{$view_data['kontak']}}</td>
                    </tr>
                @empty
                    <tr>

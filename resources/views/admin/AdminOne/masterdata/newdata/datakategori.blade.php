                ...
                <div class="container-fluid text-left">
					<div class="row">
						<div class="col-md-12 bg_page_main hd" line="hd_action">
							<div class="col-md-12 hd_page_main">Tambah Data Kategori / Gaya Renang</div>
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newkategori'] == 'Yes')<button type="button" class="btn btn-primary" name="btn_save">Simpan Data</button>@endif
									</div>
								</div>
							</div>
						</div>
									...
									<div class="row bg_data_page form_page content">
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												<label for="nama_gaya" class="col-sm-2 col-form-label">Nama Kategori <span>*</span></label>
												<div class="col-sm-10 input">
													<input type="text" name="nama_gaya" placeholder="Nama Kategori" value="{{ old('nama_gaya') }}" autofocus/>
												</div>
											</div>
										</div>
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												<label for="istilah" class="col-sm-2 col-form-label">Istilah Kategori <span>*</span></label>
												<div class="col-sm-10 input">
													<input type="text" name="istilah" placeholder="Istilah Kategori" value="-" >
												</div>
											</div>
										</div>
									</div> 

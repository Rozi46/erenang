                ...
                <div class="container-fluid text-left">
					<div class="row">
						<div class="col-md-12 bg_page_main hd" line="hd_action">
							<div class="col-md-12 hd_page_main">Tambah Data Atlet</div>
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newatlet'] == 'Yes')<button type="button" class="btn btn-primary" name="btn_save">Simpan Data</button>@endif
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12 bg_page_main" line="form_action">
							<div class="col-md-12 data_page">
								<form method="post" name="form_data" enctype="multipart/form-data" action="/admin/newatlet">
									{{csrf_field()}}
									<div class="row bg_data_page form_page content">
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-10 input">
													<input type="text" name="nis" placeholder="NIS" value="{{ old('nis') }}" autofocus/>
												</div>
											</div>
										</div>
										<div class="col-md-12 bg_form_page">
										...
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-10 input">
													<input type="text" name="tempat_lahir" placeholder="Tempat Lahir" value="" >
												</div>
											</div>
										</div>
										<div class="col-md-12 bg_form_page">
											<div class="form-group row form_input text-left">
												...
												<div class="col-sm-10 input">
                                                    ...
                                                    <input class="pointer" type="text" name="tanggal_lahir" placeholder="Tanggal Lahir" value="{{ \Carbon\Carbon::now()->subYears(20)->locale('id')->translatedFormat('d F Y') }}" readonly="true"/>
												</div>
											</div>
										</div>
										<div class="col-md-12 bg_form_page">

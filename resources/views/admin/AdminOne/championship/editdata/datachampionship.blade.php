...
@section('title', 'Ubah Data Kejuaraan')
                ...
                <div class="container-fluid text-left">
					<div class="row">
						<div class="col-md-12 bg_page_main hd" line="hd_action">
							<div class="col-md-12 hd_page_main">Ubah Data Kejuaraan</div>
						...
						<div class="col-md-12 bg_page_main form_action" line="form_action">
							<div class="col-md-12 data_page">
								<form method="post" name="form_data" enctype="multipart/form-data" action="/admin/editchampionship">
									{{csrf_field()}}
                                            ...
                                            <div class="col-md-12 bg_form_page">
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <input type="text" name="nama_kejuaraan" placeholder="Nama Kejuaraan" value="{{ $results['results']['championship']['nama_kejuaraan'] }}" autofocus/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 bg_form_page">
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <input type="text" name="lokasi" placeholder="Lokasi" value="{{ $results['results']['championship']['lokasi'] }}" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 bg_form_page">
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <input type="text" name="jumlah_line" placeholder="0" value="{{ isset($results['results']['championship']['jumlah_line']) ? number_format($results['results']['championship']['jumlah_line'], 0, ',', '') : 'Belum ditentukan' }}" onKeyPress="return goodchars(event,'0123456789',this)" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 bg_form_page">
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <input type="date" class="form-control" name="tanggal_mulai"  value="{{ \Carbon\Carbon::parse($results['results']['championship']['tanggal_mulai'])->format('Y-m-d') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 bg_form_page">
                                                <div class="form-group row form_input text-left">
                                                    ...
                                                    <div class="col-sm-10 input">
                                                        <input type="date" class="form-control" name="tanggal_selesai" value="{{ \Carbon\Carbon::parse($results['results']['championship']['tanggal_selesai'])->format('Y-m-d') }}">
                                                    </div>
                                                </div>
										    </div>
                                        </div>
            ...
            @section('script')
                <script type="text/javascript">
                    $(document).ready(function(){
                        ...
                        @if($level_user['editchampionship'] == 'Yes')
                        ...
                        $('input[name="tanggal_mulai"]').change(function(){
                            ...
                            $('input[name="tanggal_mulai"]').val(tanggal_mulai);
                        });
                
                        $('input[name="tanggal_selesai"]').change(function(){
                            var tanggal_selesai = $(this).val();
                            $('input[name="tanggal_selesai"]').val(tanggal_selesai);
                        });
                    ...
                    function DeleteData() {
                        $('div[data-model="confirmasi"]').modal({backdrop: false});
                        $('div[data-model="confirmasi"] .modal-body').html('<div class="alert alert-danger">Anda yakin untuk menghapus data {{ $results['results']['championship']['nama_kejuaraan'] }}.</div>');
                        $('button[btn-action="action-confirmasi"]').remove();
                        $('button[btn-action="close-confirmasi"]').before('<button type="button" class="btn btn-primary btn-sm" btn-action="action-confirmasi">Yakin</button>');
                        $('button[btn-action="action-confirmasi"]').click(function(){
                            if($('button[btn-action="action-confirmasi"]').click){
                                ...
                                $('button[btn-action="close-confirmasi"]').remove();
                                loadingpage(20000);
                                window.location.href = "/admin/deletechampionship?d={{ $results['results']['championship']['code_data'] }}";
                            }
                        });
                    }

							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newchampionship'] == 'Yes')<a load="true" href="/admin/newchampionship"><button type="button" class="btn btn-primary">Tambah Data</button></a>@endif
										
										@if($level_user['exportchampionship'] == 'Yes')<button type="button" class="btn btn-info back" onclick="exportdata('championship')"><i class="fa fa-download"></i> Export Data</button>@endif
									</div>
								</div>
							</div>
                        </div>
														...
														<td class="colright" style="text-align:center;">
															<div class="dropdown dropleft">
																...
																<div class="dropdown-menu">
																	...
																	<a class="dropdown-item @if($listdata['count_used'][$view_data['code_data']] > 0) disabled @endif @if($level_user['deletechampionship'] == 'No') disabled @endif" <?php if($listdata['count_used'][$view_data['code_data']] == 0){ if($level_user['deletechampionship'] == 'Yes'){ ?> btn="del_data_{{$view_data['code_data']}}"<?php } }?>>Hapus Data</a>
																</div>
															</div>
														</td>
													</tr>

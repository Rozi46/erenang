							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										<!-- @if($level_user['newheat'] == 'Yes')<a load="true" href="/admin/newheat"><button type="button" class="btn btn-primary">Tambah Data</button></a>@endif -->
																...
																if($('[btn="del_data_{{$view_data['code_data']}}"]').click){
																	...
																	$('button[btn-action="action-confirmasi"]').click(function(){
																		if($('button[btn-action="action-confirmasi"]').click){
																			...
																			loadingpage(20000);
																			window.location.href = "/admin/deleteheat?d={{$view_data['code_data']}}";
																		}
																	});
																}
															});
														...
														<td class="colright" style="text-align:center;">
															<div class="dropdown dropleft">
																...
																<div class="dropdown-menu">
																	...
																	<a load="true" class="dropdown-item" href="/admin/editheat?d={{$view_data['code_data']}}">Lihat/Ubah Data</a>
																	<a class="dropdown-item @if($view_data['count_used'] > 0) disabled @endif @if($level_user['deleteheat'] == 'No') disabled @endif" <?php if($view_data['count_used'] == 0){ if($level_user['deleteheat'] == 'Yes'){ ?> btn="del_data_{{$view_data['code_data']}}"<?php } }?>>Hapus Data</a>
																</div>
															</div>
														</td>
													</tr>

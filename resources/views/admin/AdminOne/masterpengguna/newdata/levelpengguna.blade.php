							...
							<div class="col-md-12 bg_act_page_main">
								<div class="row">
									<div class="col-xl-12 col_act_page_main text-left">
										...
										@if($level_user['newlevelusers'] == 'Yes')<button type="button" class="btn btn-primary" name="btn_save" >Simpan Data</button>@endif
									</div>
								</div>
								</div>
							</div>
									...
									<div class="row bg_data_page form_page content">
										...
										<div class="col-md-12 bg_form_page">
											<div class="form_input text-left">
												...
												<input type="text" name="level_name" placeholder="Nama Level" value="{{ old('level_name') }}" autofocus/>
											</div>
										</div>
										<div class="col-md-12 bg_form_page"> 
			...
			@section('script')
				<script type="text/javascript">
					$(document).ready(function(){   
						...
						@if($level_user['newlevelusers'] == 'Yes')
